<script lang="ts">
	...
	function addQuestion() {
		...
		ques.correctResponseIndex = document.getElementById('inputState')?.selectedIndex;
	...
	function displayQuestion(question: Question) {
		...
		document.getElementById('question' + question.questionNumber)?.classList.add('active');
		...
		document.getElementById('questionTime').value = question.timeAlotted.toString();
		document.getElementById('inputState').selectedIndex = question.correctResponseIndex;
	}
	...
	function saveChanges() {
		...
		Questions[index].timeAlotted = Number(document.getElementById('questionTime')?.value);

		Questions[index].correctResponseIndex = document.getElementById('inputState')?.selectedIndex;
	...
	<div class="quiz-create-container">
		<div class="top-container">
			...
			<div class="question-container">
				...
				<div class="buttons">
					<button on:click|preventDefault={clearQuestionList} type="submit" class="btn btn-primary"
						>Clear Questions List</button
					>
					<a href="/quiz">
			...
			<div class="quiz-form">
				<form method="get" class="row g-3 question-form">
					...
					<div class="buttons-form col-12">
						<button on:click|preventDefault={addQuestion} type="submit" class="btn btn-primary"
							>Add Question</button
						>
						<button on:click|preventDefault={clearQuestion} type="submit" class="btn btn-primary"
							>Clear Question</button
						>
						<button on:click|preventDefault={deleteQuestion} type="submit" class="btn btn-primary"
							>Delete This Question</button
						>
						<button on:click|preventDefault={saveChanges} type="submit" class="btn btn-primary"
							>Save Changes</button
						>
					</div>
				</form>
